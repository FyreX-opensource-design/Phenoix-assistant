...
def say_wind_speed():
    ...
    if wind_speed_unit == "mph":
        pyttsx3.speak("in " + get_weather("city") + " the current wind speed is " + str(convert_to_mph(int(get_weather("wind")))) + " miles per hour")
    elif wind_speed_unit == "kph":
        pyttsx3.speak("in " + get_weather("city") + " the current wind speed is " + str(convert_to_kph(int(get_weather("wind")))) + " kilometers per hour")

def say_temp():
    read_data()
    if temp_unit == "C":
        pyttsx3.speak("in " + get_weather("city") + " the current tempeture is " + get_weather("temp") + " degrees celcius")
    elif temp_unit == "F":
        pyttsx3.speak("in " + get_weather("city") + " the current tempeture is " + str(convert_temp(int(get_weather("temp")))) + " degrees farenheight")
